...
Version  : 4.16.3
Release  : 35
URL      : https://archive.xfce.org/src/xfce/exo/4.16/exo-4.16.3.tar.bz2
Source0  : https://archive.xfce.org/src/xfce/exo/4.16/exo-4.16.3.tar.bz2
...
%prep
%setup -q -n exo-4.16.3
cd %{_builddir}/exo-4.16.3
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1640708237
...
cp %{_builddir}/exo-4.16.3/COPYING %{buildroot}/usr/share/package-licenses/exo/4cc77b90af91e615a64ae04893fdffa7939db84c
cp %{_builddir}/exo-4.16.3/COPYING.LIB %{buildroot}/usr/share/package-licenses/exo/01a6b4bf79aca9b556822601186afab86e8c4fbf
%make_install
%find_lang exo-2
