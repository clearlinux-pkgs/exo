...
Source0  : http://archive.xfce.org/src/xfce/exo/0.12/exo-0.12.11.tar.bz2
...
%prep
%setup -q -n exo-0.12.11
cd %{_builddir}/exo-0.12.11
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1576774689
...
cp %{_builddir}/exo-0.12.11/COPYING %{buildroot}/usr/share/package-licenses/exo/4cc77b90af91e615a64ae04893fdffa7939db84c
cp %{_builddir}/exo-0.12.11/COPYING.LIB %{buildroot}/usr/share/package-licenses/exo/01a6b4bf79aca9b556822601186afab86e8c4fbf
%make_install
%find_lang exo-1
