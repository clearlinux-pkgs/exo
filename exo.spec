...
Source0  : http://archive.xfce.org/src/xfce/exo/0.12/exo-0.12.4.tar.bz2
...
export LANG=C
export SOURCE_DATE_EPOCH=1549127801
...
cp COPYING.LIB %{buildroot}/usr/share/package-licenses/exo/COPYING.LIB
%make_install
%find_lang exo-1
...
%files license
%defattr(0644,root,root,0755)
/usr/share/package-licenses/exo/COPYING
/usr/share/package-licenses/exo/COPYING.LIB
