...
Source0  : http://archive.xfce.org/src/xfce/exo/0.12/exo-0.12.2.tar.bz2
...
export LANG=C
export SOURCE_DATE_EPOCH=1533057978
...
export SOURCE_DATE_EPOCH=1533057978
rm -rf %{buildroot}
mkdir -p %{buildroot}/usr/share/doc/exo
cp COPYING %{buildroot}/usr/share/doc/exo/COPYING
cp COPYING.LIB %{buildroot}/usr/share/doc/exo/COPYING.LIB
%make_install
%find_lang exo-1
