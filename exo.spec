...
Version  : 0.11.2
Release  : 13
URL      : http://archive.xfce.org/src/xfce/exo/0.11/exo-0.11.2.tar.bz2
Source0  : http://archive.xfce.org/src/xfce/exo/0.11/exo-0.11.2.tar.bz2
...
%prep
%setup -q -n exo-0.11.2

%build
export LANG=C
export SOURCE_DATE_EPOCH=1492440288
...
/usr/share/gtk-doc/html/exo-1/ix01.html
